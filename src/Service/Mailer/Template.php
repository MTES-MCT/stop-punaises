...
enum Template: int
{
    ...
    case SIGNALEMENT_ESTIMATION_ACCEPTED = 50;
    case SIGNALEMENT_ESTIMATION_REFUSED = 51;
    ...
    case SIGNALEMENT_TRAITEMENT_RESOLVED_FOR_PRO = 52;
    case SIGNALEMENT_CLOSED = 53;

    case ADMIN_TOUJOURS_PUNAISES = 54;
}
