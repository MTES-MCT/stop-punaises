 ...
 *     dsn?: scalar|null|Param, // If this value is not provided, the SDK will try to read it from the SENTRY_DSN environment variable. If that variable also does not exist, the SDK will just not send any events.
 ...
 *     transport_factory?: scalar|null|Param, // The service ID of the transport factory used by the default SDK client. // Default: "Sentry\\Transport\\TransportFactoryInterface"
 *     options?: array{
 *         integrations?: list<scalar|null|Param>,
 *         default_integrations?: bool|Param,
 *         send_attempts?: int|Param,
 ...
 * }
 * @psalm-type SineflowClamAvConfig = array{
 *     strategy?: scalar|null|Param, // Default: "clamd_unix"
 ...
 *     sineflow_clam_av?: SineflowClamAvConfig,
 *     "when@dev"?: array{
 *         imports?: ImportsConfig,
 *         parameters?: ParametersConfig,
 *         services?: ServicesConfig,
